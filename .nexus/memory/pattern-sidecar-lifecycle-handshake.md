...
본 패턴의 dev launch 통합은 plan #16 H2에서 SidecarBridge swap으로 완성되었다. SidecarProcessRuntime은 deprecated 처리되었으며, SidecarBridge가 electron-app-composition의 서비스 그래프에 wire된 이후에야 실제 end-user 경로에서 lifecycle handshake가 동작한다.
