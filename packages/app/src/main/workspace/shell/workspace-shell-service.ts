...
import type { OpenSessionSidecarLifecycleManager } from "../../sidecar/sidecar-lifecycle-manager";
import type { ClaudeSettingsDetection } from "../../claude/claude-settings-manager";
