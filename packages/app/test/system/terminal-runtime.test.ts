...
import type { TerminalHostCreateOptions, TerminalHostEnvironmentResolver } from "../../src/main/terminal/terminal-host";
import {
  WorkspaceTerminalRegistry,
  type WorkspaceTerminalHost,
  type WorkspaceTerminalHostFactory,
} from "../../src/main/workspace/shell/workspace-terminal-registry";
import {
  ShellTerminalTabs,
...
} from "../../src/renderer/terminal/shell-terminal-tab";
...
describe("terminal runtime verification harness", () => {
