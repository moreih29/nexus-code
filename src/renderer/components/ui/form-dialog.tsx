              ...
              <div className="flex items-center gap-2">
                {field.multiline ? (
                  <textarea
                    ...
                    className={`min-h-20 w-full resize-y rounded-sm border border-mist-border bg-background px-2 py-1 text-app-body text-foreground outline-none focus-visible:ring-1 focus-visible:ring-mist-border-focus ${field.inputClassName ?? ""}`}
                  ...
                  <input
                    ...
                    onChange={(event) => onValueChange(field.name, event.target.value)}
                    placeholder={field.placeholder}
                    className={`w-full rounded-sm border border-mist-border bg-background px-2 py-1 text-app-body text-foreground outline-none focus-visible:ring-1 focus-visible:ring-mist-border-focus ${field.inputClassName ?? ""}`}
                    aria-invalid={error ? true : undefined}
                    aria-describedby={error || field.helperText ? helpId : undefined}
                    disabled={busy}
                    readOnly={field.readOnly}
