    ...
    <>
      ...
      <form className="mt-4 flex flex-col gap-2" onSubmit={onSubmit}>
        ...
        <textarea
          ...
          className="min-h-52 w-full resize-y rounded-sm border border-mist-border bg-background px-2 py-1 font-mono text-app-code text-foreground outline-none focus-visible:ring-1 focus-visible:ring-mist-border-focus"
          disabled={busy}
        />
  ...
  return (
    ...
    >
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content
          className="fixed left-1/2 top-1/2 z-50 w-[560px] max-w-[92vw] -translate-x-1/2 -translate-y-1/2 rounded-md border border-mist-border bg-background p-5 text-foreground shadow-lg outline-none"
