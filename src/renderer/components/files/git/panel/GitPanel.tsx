...
import {
  ...
  submitBranchCreate,
} from "../branch/BranchCreateDialog";
import { BranchPicker, type BranchPickerMode } from "../branch/BranchPicker";
import { type CommitPickItem, createCommitPickerSource } from "../commit/commit-picker-source";
import { ConfirmDiscardDialog, type DiscardConfirmRequest } from "../clone/ConfirmDiscardDialog";
import { GitBranchBar } from "../branch/GitBranchBar";
import { GitCommitInput } from "../commit/GitCommitInput";
import { GitEmptyState } from "./GitEmptyState";
import { GitGroup } from "../file-row/GitGroup";
...
} from "../pickers/MergeOptionsDialog";
import {
...
import { StashPicker } from "../pickers/StashPicker";
