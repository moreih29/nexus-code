...
import { cancelCommitDraftSave } from "../git-draft-persistence";
import { persistPanelState } from "../git-panel-state-io";
import { resolveCommitOptions } from "../git-session-defaults";
import {
  isAbortError,
  isPendingNonFFError,
...
export interface OperationsSlice {
  ...
  discard: (workspaceId: string, relPaths: string[], source?: import("../../../../shared/git/types").GitExpandedGroupKey) => Promise<void>;
  commit: (workspaceId: string, options?: CommitOptions) => Promise<CommitResult | undefined>;
  commitAmend: (workspaceId: string, options?: Omit<CommitOptions, "amend">) => Promise<CommitResult | undefined>;
  ...
  merge: (workspaceId: string, branch: string, mode?: GitMergeMode) => Promise<GitMergeResult | undefined>;
  ...
  markResolved: (workspaceId: string, paths: string[]) => Promise<GitMarkResolvedResult | undefined>;
  resetSoft: (workspaceId: string, targetSha: string) => Promise<boolean>;
  createBranch: (workspaceId: string, name: string, checkoutOrOptions?: boolean | CreateBranchOptions) => Promise<void>;
  ...
  fastForwardBranch: (workspaceId: string, branch: string, remote: string, remoteRef: string) => Promise<GitFastForwardResult | undefined>;
  ...
  createTag: (workspaceId: string, name: string, options?: { ref?: string; message?: string }) => Promise<boolean>;
  ...
  setAutofetchInterval: (workspaceId: string, intervalMin: import("../../../../shared/git/types").GitAutofetchIntervalMin) => Promise<void>;
