...
import { GitAutofetchScheduler } from "./features/git/domain/git-autofetch";
import { GitHelpersIpcManager, registerGitHelperIpcChannels } from "./features/git/domain/helpers/git-helpers-ipc";
import { GitRegistry } from "./features/git/domain/git-registry";
