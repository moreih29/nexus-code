...
interface CloneProgressParserOptions {
  readonly now?: () => number;
...
/**
 * Stateful parser that emits phase transitions immediately and progress
 * samples at the configured throttle interval.
 */
export class GitCloneProgressParser {
  ...
  constructor(options: CloneProgressParserOptions = {}) {
